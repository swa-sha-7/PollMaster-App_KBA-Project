...
const VoterLogin = () => {
    ...
    const checkLogin = async (loginCreds)=>{
        const res = await fetch('/api/voter/loginVoter',{
            method:'POST',
            headers:{  
...
<div className="flex justify-center font-[500] text-[30px] text-[#2866AB] mt-10 font-[600] ">VOTER'S LOGIN</div>
    ...
    <div className="grid grid-row-3  mt-8 mr-10 justify-items-center place-content-center p-5 rounded-md h-[250px] m-auto">
        ...
        <div className="border-t border-[black]">
            ...
            <p className="mt-2 ">
                ...
                <br />
                <a className=" m-2  mt-2 mb-2 py-1 px-3  rounded-md text-[#172B4D] hover:underline" href="/voterRegistrationForm">Sign Up</a>
                <span>here</span>
            </p>
        </div>
    </div>
