...
const CandidateNavBar = () => {
  return (
    ...
    <div className="flex flex-row bg-[#409D9B] gap-2 justify-center items-center">
        <div className="hover:underline hover:text-white m-2 p-2 rounded-md"><a href="/CandidateHome">HOME</a></div>
        <div className="hover:underline hover:text-white m-2 p-2 rounded-md"><a href="/CompleteRegistrationCandidate">Complete Registration</a></div>
        <div className="hover:underline hover:text-white m-2 p-2 rounded-md"><a href="/CandidateAppStatus">View Approval Status</a></div>
        {/* <div className="bg-[#DBF094]  m-2 p-2 rounded-md"><a href="/CandidateProposal">Upload Your Proposals</a></div> */}
        <div className="hover:underline hover:text-white  m-2 p-2 rounded-md"><a href="/viewResultCandidate">View Results</a></div>
    </div>
